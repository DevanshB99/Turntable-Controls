...
scriptDir = '/Users/devanshbajwala/Documents/PhD/Visual Inspection/Turntable_Project/Turntable-Controls/Stepper Motor Controls/ID_Tuned';
...
% Test parameters
target_angle = 180;  % Target position (deg)
...
% Overshoot: largest excursion past target, only counted once the
% response actually crosses target (falling short isn't overshoot,
% it's steady-state error, already captured above)
